...
print(f"По статистике: {Fore.CYAN}{len(steps_more_10k)}{Style.RESET_ALL} из {Fore.CYAN}{str(len(STEPS))}{Style.RESET_ALL} дней ({Fore.CYAN}{(round(percent_steps_more_10k, 1))}{Style.RESET_ALL} %), за которые пройдено более 10к шагов, на протяжении дня.")
