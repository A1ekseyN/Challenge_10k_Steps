...
is_setting_hour_statistics = True     # Статистика по кол-ву шагов в конкретный час дня.
is_setting_month_year_stat_steps = True     # Статистика по кол-ву шагов по месяцам
...
STEPS = steps + [10204, 10039, 8469, 7859, 10725, ]
