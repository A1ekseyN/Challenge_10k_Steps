...
is_setting_achievement = False           # Отображение ачивок
...
STEPS = steps + [10204, 10039, 8469, 7859, 10725, 10170, 10444, 10092, 10788, ]
...
# !!! Правил код, и оставил старый. Вдруг, что-то где-то не так заработает.
